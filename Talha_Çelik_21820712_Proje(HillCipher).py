...
##########################################################################################################################
# Oluşturduğum test senaryosunda istenilen matris için ekranda gördüğünüz matrisi girmelisiniz ki doğru sonuç versin.    #
# Blok uzunluğunu 3 seçmeniz parmaklarınızın yararına olacaktır diğer senaryoları ben denedim ama denemesi hoş değil :)  #
##########################################################################################################################
